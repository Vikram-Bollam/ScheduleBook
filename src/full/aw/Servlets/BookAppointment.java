...
public class BookAppointment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String status = sc.bookSchedule(userid, req.getParameter("custName"), req.getParameter("custEmail"),
				req.getParameter("date"), time ,req.getParameter("service"));
		if (status != null) {
			PrintWriter out = resp.getWriter();
			out.print("<script>alert('Appointment Bookeed !! ');</script>");
